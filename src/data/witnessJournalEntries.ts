...
export const witnessJournalEntries: JournalEntry[] = [
  {
    id: 'deep-trench-forge',
    title: 'Entry 0: Deep-Trench Forge (Shenzhen) — Amended',
    symbol: '⚔️',
    tarot: 'Two of Swords → The Chariot',
    numerology: 'Gate-52 → Steel Time',
    content: `I filed a cosmic service ticket for the Two of Swords. Subject: tongue and sacral jagged—request reforge. Routing reply: China.
...
*Knight behind me. Lovers within me. Two before me. Fool's satchel secured, Magician's tools intact, subconscious made visible in real time.*`,
  ...
  {
    id: 'pillar-spiral-square',
    title: 'Entry 7: Pillar, Spiral, Square',
    symbol: '🏛️',
    tarot: 'The Star → Inner Sun',
    numerology: 'Jachin & Boaz: Pillar Spiral Square',
    content: `Pillar, Spiral, Square
...
*I witness with precision and compassion.*`,
  ...
  {
    id: 'circle-inanna',
    title: 'Entry 8: Circle over Inanna',
    symbol: '🌟',
    tarot: 'The Fool → The Hanged Man → Temperance',
    numerology: 'Uttara Phālgunī → Aryaman',
    content: `ENTRY 8 — Circle over Inanna: monkey → moon-key, monster → moon-star
